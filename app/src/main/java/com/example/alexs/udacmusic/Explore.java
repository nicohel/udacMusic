    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        library.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent libraryIntent = new Intent(Explore.this, Library.class);
        ...
        explore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent exploreIntent = new Intent(Explore.this, Explore.class);
        ...
        radio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent radioIntent = new Intent(Explore.this, Radio.class);
        ...
        mainActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent mainActivityIntent = new Intent(Explore.this, MainActivity.class);
